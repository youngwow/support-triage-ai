...
регламентам (RAG по базе знаний), умеет вызывать функции («сколько у меня дней
отпуска», «какой у меня грейд»), а критичные и внерегламентные запросы
эскалирует на оператора. Курсовой проект AITH «System Design».
